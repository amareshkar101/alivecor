...
const AlivecorAboutComponent = () => {
  return (
    <>
      <div className="w-full bg-brand-accent-light text-outfit relative">
        <div className="text-center">
          <div className="flex flex-col space-y-4 justify-center">
            <p className="text-[40px] text-brand-dark font-[700] mt-[3%]">
              Kardia By Alivecor
            </p>
            <p className="text-[14px] text-[#666666] px-[17%] font-[700]">
        ...
        <div className="w-full flex justify-center spaxe-x-6 absolute top-[45%]">
          <div className="bg-white rounded-xl p-8 w-[18%] text-center shadow-xl mx-[2%]">
            <p className="text-[40px] font-[900] text-brand-dark">
              23<span className="text-brand-accent">+</span>
            </p>
            <p className="text-[12px] text-[#666666] font-[700]">Countries</p>
          </div>
          <div className="bg-white rounded-xl p-8 w-[18%] text-center shadow-xl mx-[2%]">
            <p className="text-[40px] font-[900] text-brand-dark">
              9600<span className="text-brand-accent">+</span>
            </p>
            <p className="text-[12px] text-[#666666] font-[700]">Hospitals</p>
          </div>{" "}
          <div className="bg-white rounded-xl p-8 w-[18%] text-center shadow-xl mx-[2%]">
            <p className="text-[40px] font-[900] text-brand-dark">
              5-<span className="text-brand-accent">Star</span>
            </p>
            <p className="text-[12px] text-[#666666] font-[700]">
              reviews on Amazon
            </p>
          </div>{" "}
          <div className="bg-white rounded-xl p-8 w-[18%] text-center shadow-xl mx-[2%]">
            ...
            <p className="text-[12px] text-[#666666] font-[700]">ECGs Daily</p>
          </div>
        </div>
      </div>
    </>
